...
<!--
    <link xhref="/css/bootstrap.min.css" rel="stylesheet">
    <link xhref="/css/font-awesome.min.css" rel="stylesheet">
    <link xhref="/css/prettyPhoto.css" rel="stylesheet">
    <link xhref="/css/animate.css" rel="stylesheet">
    <link xhref="/css/main.css" rel="stylesheet">
    <link xhref="/css/responsive.css" rel="stylesheet">
-->
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="{{ route('store.orders') }}"><i class="fa fa-user"></i> Minha conta</a></li>
...
<script ssrc="js/bootstrap.min.js"></script>
<script ssrc="js/jquery.scrollUp.min.js"></script>
<script ssrc="js/jquery.prettyPhoto.js"></script>
<script ssrc="js/main.js"></script>
-->
