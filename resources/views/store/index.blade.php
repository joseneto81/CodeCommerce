        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                <div class="productinfo text-center">
                    ...
                    <p>{{$product->name}}</p>
                    <a href="http://commerce.dev/product/2" class="btn btn-default add-to-cart"><i class="fa fa-crosshairs"></i>Mais detalhes</a>
                ...
                <div class="product-overlay">
                    <div class="overlay-content">
                        ...
                        <a href="http://commerce.dev/cart/2/add" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Adicionar no carrinho</a>
                    </div>
                </div>
            </div>
          </div>
